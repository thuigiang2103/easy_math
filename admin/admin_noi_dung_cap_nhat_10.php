    ...
    <li class="nav-item ">
        ...
        <div id="collapsechuong<?php echo $row["chi_tiet_id"];  ?>" class="collapse" aria-labelledby="headingchuong<?php echo $row["chi_tiet_id"];  ?>" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" onclick="return confirm('Bạn muốn xóa bài giảng?');" href="admin_xoa_bai_giang_10.php?id=<?php echo $row["chi_tiet_id"];?>">Xóa</a>
          </div>
        </div>
      </li>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="mb-2">
                      ...
                      ;?>
                        <form action="../admin/admin_cap_nhat_bai_giang_thuc_hien_10.php" onsubmit="return check_du_lieu()" method="POST" enctype="multipart/form-data" >
