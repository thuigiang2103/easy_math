    ...
    <li class="nav-item ">
        ...
        <div id="collapsechuong<?php echo $row["chi_tiet_id"];  ?>" class="collapse" aria-labelledby="headingchuong<?php echo $row["chi_tiet_id"];  ?>" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="admin_xoa_bai_giang_12.php?id=<?php echo $row["chi_tiet_id"];?>">Xóa</a>
          </div>
        </div>
      </li>
                ...
                <div class="card-body">
                  ...
                  <div class="mb-2">
                   ...
                   <?php 
                      ...
                      ;?>
                       <form action="../admin/admin_cap_nhat_chuong_thuc_hien_12.php"method="POST" enctype="multipart/form-data">
